...
Dim RS_EMPRESA As ADODB.Recordset
Option Explicit
...
If KeyCode = 118 Then 'ignore low-ASCII characters like
    Ventas2.Show
End If
End Sub
...
With RS_EMPRESA
    ...
    Else
     DIM_DIRECCION = .Fields("DIRECCION")
     DIM_TELEFONO = .Fields("TELEFONO1")
     DIM_NIVEL = .Fields("NIVEL")
     DIM_TIENDA = .Fields("TIENDA")
     DIM_RTN = .Fields("RTN")
     DIM_TIPO = .Fields("TIPO")
     DIM_IMPUESTO = .Fields("IMPUESTO")
     DIM_FORMAVENTA = .Fields("VENTA")
     DIM_EMPRESA = .Fields("EMPRESA")
    End If
End With
RS_EMPRESA.Close
End Sub
...
Private Sub ucMenu1_ButtonClick( _
    ...
    With Button
        ...
        If .Caption = "REPORTES" Then
            Reportes.Show
        End If
        If .Caption = "CUADRE" Then
            FRMCUADRE.Show
        End If
        If .Caption = "SALIR" Then
            End
        End If
    End With
End Sub
