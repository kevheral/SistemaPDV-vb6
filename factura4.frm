...
PRVT_2.CommandText = "SELECT Producto,Salida,Total,TAX  FROM InvSalida1 WHERE NDVentas like '" & DIM_NODOC & "'"
...
RS_TOTAL.Open "Select SUM(TOTAL),SUM(valor),SUM(ISV) from InvSalida1 where NDVentas like '" & DIM_NODOC & "'", PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
'$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
