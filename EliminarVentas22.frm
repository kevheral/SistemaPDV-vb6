...
Begin VB.Form EliminarVentas2 
   ...
   Begin VB.CommandButton BTN1 
      ...
      Index           =   3
      Left            =   3405
      Picture         =   "EliminarVentas22.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   0
      Width           =   1215
   ...
   Begin VB.CommandButton BTN1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "EliminarVentas22.frx":438C
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   0
      Width           =   1100
   ...
   Begin VB.CommandButton BTN1 
      ...
      Index           =   1
      Left            =   1095
      Picture         =   "EliminarVentas22.frx":8793
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   0
      Width           =   1215
   ...
   Begin VB.CommandButton BTN1 
      ...
      Index           =   2
      Left            =   2310
      Picture         =   "EliminarVentas22.frx":C999
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   0
      Width           =   1100
   ...
   Begin VB.CommandButton BTN8 
      ...
      Height          =   1000
      Left            =   4620
      Picture         =   "EliminarVentas22.frx":10C71
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   0
      Width           =   1100
   ...
   Begin VB.CommandButton BTN9 
      ...
      Height          =   1000
      Left            =   5670
      Picture         =   "EliminarVentas22.frx":14DC0
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   0
      Width           =   1100
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   1000
      Left            =   8070
      Picture         =   "EliminarVentas22.frx":191D7
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   0
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "EliminarVentas2"
...
End If
 ...
 '       RS_SALIDA_2.Open "SELECT Codigo,Producto,Salida,Descuento,punitario,ISV,Valor,total,ClientE,NDVentas,ID,fecha,Hora1,tax,Tipo,Descripcion,cliente,Costo,NoDE,caja,DEI,FORMA,vendedor,TARJETA,COLOR FROM InvSalida1 WHERE ndventas like '" & RS_VENTAS.Fields("NDVentas") & "' ", PUB_CONEXION_EASY, adOpenDynamic, adLockOptimistic
'        DIM_SQL = "SELECT Codigo,Producto,Salida,punitario,valor,ncliente,cliente,fecha,Hora1,Descripcion,NDVentas,forma,total,Vendedor FROM InvSalida1 WHERE ndventas like '" & RS_VENTAS.Fields("NDVentas") & "' "

        DIM_SQL = "SELECT Codigo,Producto,Salida,punitario,NDVentas,TOTAL,ncliente,cliente,fecha,Hora1,Descripcion FROM InvSalida1 WHERE ndventas like '" & PUB_10 & "' "
...
'''''''''''''''''''''''''''''''''''
    ...
    PRVT_2.CommandText = "SELECT SUM(Valor),SUM(Salida) As UnitsSold FROM InvSalida1 WHERE NDVentas like '" & PUB_10 & "' "
...
PRVT_2.ActiveConnection = PRVT_1
PRVT_2.CommandType = adCmdText
PRVT_2.CommandText = "SELECT Codigo,Producto,Salida,Valor  FROM InvSalida1 WHERE NDVentas like '" & PUB_10 & "' "
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    PRVT_2.ActiveConnection = PRVT_1
    PRVT_2.CommandType = adCmdText
    PRVT_2.CommandText = "DELETE * FROM InvSalida1 WHERE ndventas like '" & RS_VENTAS.Fields("NDVentas") & "' "
    Set PRVT_3 = PRVT_2.Execute
    PRVT_1.Close
    '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    'PRVT_2.ActiveConnection = PRVT_1
    'PRVT_2.CommandType = adCmdText
    'PRVT_2.CommandText = "DELETE * FROM InvSalida1 WHERE NDVentaslike '" & RS_VENTAS.Fields("NDoc") & "' "
    'Set PRVT_3 = PRVT_2.Execute
    'PRVT_1.Close
    '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    Set nocli = New Recordset
    DIM_SQL = "DELETE * from ventasdos WHERE nodoc= " & RS_VENTAS.Fields("NDVentas")
    ...
    RS_VENTAS.Open "select * from InvSalida1 Order by NDVentas", PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
...
Dim DIM_SQL, DIM_FORMA
     ...
     'DIM_FORMA = "CONTADO"
     DIM_SQL = "select * from InvSalida1 ORDER BY ndventas ASC "
...
RS_CUENTAS_INGRESOS.Open "Select NoDoc4 from ventasdos", PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
...
With RS_VENTAS
    .AddNew
        ...
        Set RS_SALIDA = New Recordset
'        RS_SALIDA.Open "SELECT Codigo,Producto,salida,Descuento,Valor,Saldo,NDVentas,Periodot,fecha,Hora1,caja FROM InvSalida1 WHERE NDVentaslike '" & RS_VENTAS.Fields("NDoc") & "' ", PUB_CONEXION_EASY, adOpenDynamic, adLockOptimistic
         RS_SALIDA.Open "SELECT Codigo,Producto,Salida,punitario,dventas,total,ncliente,cliente,fecha,Hora1,Descripcion,NDVentas,forma,Vendedor FROM InvSalida1 WHERE NDVentas like '" & RS_VENTAS.Fields("NDoc") & "' ", PUB_CONEXION_EASY, adOpenDynamic, adLockOptimistic
...
Dim en, sa, de, so, fa, DIM_TOTAL_ENTRADAS, DIM_TOTAL_SALIDA, saldo1
    ...
    PRVT_2.CommandText = "SELECT SUM(Entrada),SUM(Faltante),SUM(Sobrante),SUM(Devolucion) As UnitsSold FROM InvSalida1 WHERE Codigo=" & DIM_INT_6
    Set PRVT_3 = PRVT_2.Execute
    '
    If Not IsNull(PRVT_3.Fields(0)) Then
    en = PRVT_3.Fields(0)
...
Set RS_BORRAR = New Recordset
    ...
    DIM_SQL = "SELECT * from ventasdos"
    nocli.Open DIM_SQL, PUB_CONEXION_EASY, adOpenStatic, adLockReadOnly

Do While Not nocli.EOF
DIM_A = nocli.Fields("nodoc")
    DIM_SQL_VASIO = "SELECT * FROM InvSalida1 WHERE ndventas like '" & DIM_A & "' "
    
    RS_VASIO.Open DIM_SQL_VASIO, PUB_CONEXION_EASY, adOpenStatic, adLockReadOnly
    
    If RS_VASIO.EOF Then
           
    DIM_SQL_VASIO = "DELETE * from ventasdos WHERE nodoclike '" & DIM_A & "' "
...
DIM_SQL = "SELECT Codigo,Producto,Salida,punitario,NDVentas,TOTAL,ncliente,cliente,fecha,Hora1,Descripcion,forma,tienda FROM InvSalida1 WHERE ndventas like '" & Text1.Text & "' "
...
Set RS_SALIDA_2 = New Recordset
DIM_SQL = "select * from InvSalida1 where ndventas like '" & RS_VENTAS.Fields("NDVentas") & "' "
...
Set RS_TOTAL = New Recordset
' "Select SUM(TOTAL),SUM(ISV),SUM(DESCUENTO),SUM(valor) from InvSalida1 where ndventas  =  " & DIM_NODOCC, PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
'DIM_SUMTOTAL = RS_TOTAL.Fields(0)
RS_TOTAL.Open "SELECT Codigo,Producto,ISV,Salida,punitario,FORMA,TOTAL  FROM InvSalida1 where NDVentas like '" & DIM_NODOC & "'", PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
...
' "Select SUM(TOTAL),SUM(ISV),SUM(DESCUENTO),SUM(valor) from InvSalida1 where ndventas  =  " & DIM_NODOCC, PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
'DIM_SUMTOTAL = RS_TOTAL.Fields(0)
RS_TOTAL.Open "SELECT sum(total),sum(isv)  FROM InvSalida1 where ndventas  like '" & DIM_NODOC & "'", PUB_CONEXION_EASY, adOpenKeyset, adLockOptimistic
...
DIM_A = MsgBox("DESEA ELIMINAR TODA LA TRANSACCION", vbYesNo)
    If DIM_A = vbYes Then
            ...
            '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$''''''''''''''''''''''''''''''''''''''''
                        ...
                        PUB_SQL = "select Codigo,Producto,Salida,Total,forma  FROM InvSalida1 WHERE ndventas like '" & PUB_10 & "' "
...
'$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$''''''''''''''''
            ...
            Set RS_SALIDA = New Recordset
            DOCELIMINAR = ""
            RS_SALIDA.Open "SELECT Codigo,Producto,Salida,punitario,ndventas,total,ncliente,cliente,fecha,Hora1,Descripcion,NDVentas,forma,Vendedor  FROM InvSalida1", PUB_CONEXION_EASY, adOpenDynamic, adLockOptimistic
            RS_SALIDA.MoveFirst
            RS_SALIDA.MoveLast
            Carga_lstvDatos
            End With
