...
Dim DIM_ISV, DIM_DESCUENTO, DIM_VALOR
Dim DIM1
Dim DIM2
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  For i = 1 To 1   ' Set up two iterations.
 DIM_TITULO = "Bo EL CENTRO, Ave Hipolito Matute"
 HWidth = Printer.TextWidth(DIM_TITULO) / 2   ' Get one-half width.
 Printer.CurrentX = Printer.ScaleWidth / 2 - HWidth
 Printer.Print DIM_TITULO  ' Send new page.
Next i
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  For i = 1 To 1   ' Set up two iterations.
 DIM_TITULO = "Esq Opuesta Bnco Trabajadores"
 HWidth = Printer.TextWidth(DIM_TITULO) / 2   ' Get one-half width.
 Printer.CurrentX = Printer.ScaleWidth / 2 - HWidth
 Printer.Print DIM_TITULO  ' Send new page.
Next i
...
Printer.Print ""
  For i = 1 To 1   ' Set up two iterations.
 DIM_TITULO = "E-Mail: albertolanza1967@gmail.com"
 HWidth = Printer.TextWidth(DIM_TITULO) / 2   ' Get one-half width.
 Printer.CurrentX = Printer.ScaleWidth / 2 - HWidth
 Printer.Print DIM_TITULO  ' Send new page.
Next i
...
Printer.Print ""
  For i = 1 To 1   ' Set up two iterations.
 DIM_TITULO = "Cliente :" & DIM_CLIENTVNT
 HWidth = Printer.TextWidth(DIM_TITULO) / 2   ' Get one-half width.
 Printer.CurrentX = Printer.ScaleWidth / 2 - HWidth
 Printer.Print DIM_TITULO  ' Send new page.
Next i
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  For i = 1 To 1   ' Set up two iterations.
 DIM_TITULO = "RNT CLNTE :" & DIM_RTNCl
 HWidth = Printer.TextWidth(DIM_TITULO) / 2   ' Get one-half width.
 Printer.CurrentX = Printer.ScaleWidth / 2 - HWidth
 Printer.Print DIM_TITULO  ' Send new page.
Next i
...
PRVT_2.CommandText = "SELECT Producto,Salida,Total  FROM INVSalida WHERE NDVentas like '" & DIM_NODOC & "'"
...
Do While Not PRVT_3.EOF
        ...
        Printer.CurrentX = LEFT_MARGIN
        Printer.Print PRVT_3!salida & "      " & PRVT_3!Producto & "     L. " & PRVT_3!Total
...
'$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$''''''''''''''''''''''''''''''''''
Printer.Print "_______________________________ "
 DIM_TITULO = "Cantidad = " & vbTab & vbTab & lblST
 Printer.Print DIM_TITULO  ' Send new page.
 
 DIM_TITULO = "Impuesto S/Ventas = " & vbTab & Format(DIM_SUMISV, "#,##0.00")
 Printer.Print DIM_TITULO  ' Send new page.
 DIM_TITULO = "Pagado  = " & vbTab & vbTab & Format(TXT_CANTIDAD, "#,##0.00")
 Printer.Print DIM_TITULO  ' Send new page.
...
'$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$''''''''''''''''''''''''''''''''''
For i = 1 To 1   ' Set up two iterations.
 DIM_TITULO = "Fecha Limite : 16-03-2016 "
 HWidth = Printer.TextWidth(DIM_TITULO) / 2   ' Get one-half width.
 Printer.CurrentX = Printer.ScaleWidth / 2 - HWidth
 Printer.Print DIM_TITULO  ' Send new page.
Next i
